...
let CoordinatorModel = CoordinatorModel_1 = class CoordinatorModel {
    constructor(configService) {
        this.configService = configService;
        this.logger = new common_1.Logger(CoordinatorModel_1.name);
...
CoordinatorModel = CoordinatorModel_1 = __decorate([
    common_1.Injectable(),
